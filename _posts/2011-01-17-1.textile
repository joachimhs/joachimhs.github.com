--- 
title: Integrating a Sproutcore client in a deployable .WAR file
layout: post
---
...
<h2>Installing garcon for the SC 1.4.4 STABLE branch</h2>
The main garcon source is avaible at GitHub at https://github.com/martoche/garcon. I wanted to place garcon inside my project, and so decided to clone garcon into a subfolder named "garcon" into my main Sproutcore project directory by issuing the following command. which is really all that is needed to "install" garcon:
...
<h2>Executing the Garcon build with node.js</h2>
...
<h2>Integrating the built SC Application inside the Java .WAR</h2>
...
<h2>Source Code</h2>
The complete source code is availble on Github: <a href="https://github.com/joachimhs/EurekaJ">https://github.com/joachimhs/EurekaJ</a>